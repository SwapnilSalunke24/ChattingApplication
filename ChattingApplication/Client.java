...
public class Client  implements ActionListener {
    ...
    Client(){
        ...
        //profile image
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("com/icons/client.png")); //load image
        ...
        f.setLocation(800, 50); //set location
    ...
    public static void main(String args[]){
        ...
        try{
            ...
            DataInputStream din = new DataInputStream(a.getInputStream()); //read msg
            dout = new DataOutputStream(a.getOutputStream()); //send msg
